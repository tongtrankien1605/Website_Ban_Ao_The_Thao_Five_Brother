                                    ...
                                    <td>
                                        <button class="dropbox-arrow-icon order-details-btn" data-state="closed">
                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <path class="arrow-icon" d="M6 9L12 15L18 9" stroke="#0061FF"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path class="close-icon" d="M6 6L18 18M6 18L18 6" stroke="#FF0000"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    style="display: none;" />
                                            </svg>
                                        </button>
                                                ...
                                                @if (
                                                    ...
                                                    <div class="text-center">
                                                        <form action="{{ route('order.update', $order->id) }}"
                                                            ...
                                                            @csrf
                                                            @method('PUT')
                                                            <input type="hidden" name="id_order_status"
                                                    ...
                                                    <div>
                                                        <form action="{{ route('order.update', $order->id) }}"
                                                            ...
                                                            <input type="text" name="reason"
                                                                class="form-control mb-2" placeholder="Lý do"
                                                    ...
                                                    <div class="card p-4 mt-4 shadow-sm">
                                                        <div id="confirm-section" class="text-center">
                                                            <form action="{{ route('order.update', $order->id) }}"
                                                                ...
                                                                <button type="submit" class="btn btn-success me-2">Đã
                                                                    nhận được hàng</button>
                                                            </form>
                                                            @if ($order->payment_method_status_name === 'Đã thanh toán')
                                                                <button class="btn btn-warning btnbtn">Hoàn
                                                                    hàng</button>
                                                            @else
                                                                <button class="btn btn-warning btnbtn">Chưa
                                                                    nhận được hàng</button>
                                                            @endif
                                                            ...
                                                            @if ($order->payment_method_status_name === 'Đã thanh toán')
                                                                <form action="{{ route('order.update', $order->id) }}"
                                                                    ...
                                                                    <h5 class="text-center mb-3 fs-4">
                                                                        Bạn muốn hoàn hàng? Vui lòng nhập thông tin:
                                                                    </h5>
...
value="{{ OrderStatus::FAILED }}"> --}}
                                                                    ...
                                                                    <div class="text-center">
                                                                        <button type="submit"
                                                                            ...
                                                                            onclick=" return confirm('Bạn chắc chắn muốn hủy đơn hành và những thông tin mình đã nhập?')">Gửi
                                                                            yêu cầu</button>
                                                                        <button type="button"
                                                            ...
                                                            @elseif($order->payment_method_status_name === 'Chưa thanh toán')
                                                                <form id="refund-form-2"
                                                                    ...
                                                                    <input type="hidden"name="id_order_status"
                                                                        value="{{ OrderStatus::AUTHEN }}">
                                                                    <div class="text-center">
                                                                        <button
                                                                            type="submit"class="btn btn-danger me-2"
                                                                            onclick=" return confirm('Bạn có muốn thực hiện hành động này?')">Gửi
                                                                            yêu
                                                                            cầu</button><button
                                                            ...
                                                            <div id="confirm-section" class="text-center">
                                                                <form action="{{ route('order.update', $order->id) }}"
                                                                    ...
                                                                    <button type="submit"
                                                                        ...
                                                                        onclick="return confirm('Xác nhận giao lại.')">Giao
                                                                        lại</button>
                                                                </form>
                                                                @if ($order->payment_method_status_name === 'Đã thanh toán')
                                                                    <button class="btn btn-warning btnbtn">Hủy
                                                                        đơn</button>
                                                                @else
                                                                    <form
                                                                        action="{{ route('order.update', $order->id) }}"
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            onclick="return confirm('Bạn chắc chắn muốn hủy đơn')">Hủy
                                                                            đơn</button>
                                                                    </form>
                                                                @endif
...
value="{{ OrderStatus::FAILED }}"> --}}
                                                                        ...
                                                                        <div class="text-center">
                                                                            <button type="submit"
                                                                                class="btn btn-danger me-2"
                                                                                onclick="return confirm('Bạn chắc chắn muốn hủy đơn')">Gửi
                                                                                yêu cầu</button>
                                                                            <button type="button"
                                                                                class="btn btn-secondary btnbtn">Hủy</button>
                                                                        </div>
                                                        ...
                                                        @elseif ($order->id_order_status == OrderStatus::SUCCESS)
                                                            <div class="alert alert-success text-center">
                                                                Cảm ơn quý khách đã mua hàng của
                                                                shop chúng tớ!
                                                            </div>
                                                        ...
                                                        @elseif ($order->id_order_status == OrderStatus::REFUND_SUCCESS)
                                                            <div class="alert alert-success text-center">
                                                                ...
                                                                xử lý. Số tiền được hoàn trả!
                                                            </div>
                                                        @elseif ($order->id_order_status == OrderStatus::REFUND_FAILED)
                                                            <div class="alert alert-danger text-center">
                                                                Yêu cầu hoàn hàng của bạn Không được
                                                                chấp nhận. Vui lòng liên hệ shop để biết thêm thông tin
                                                                chi tiết!
                                                            </div>
