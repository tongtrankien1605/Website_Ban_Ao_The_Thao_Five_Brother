                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="discount_value" name="discount_value"
                                                        placeholder="Vui lòng nhập giá trị" value="{{ old('discount_value') }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="total_usage" name="total_usage"
                                                    placeholder="Nhập số lần sử dụng" value="{{ old('total_usage') }}">
                                                @error('total_usage')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control flatpickr-input" id="start_date" name="start_date" value="{{ old('start_date') }}" placeholder="Chọn ngày bắt đầu" style="width: 100%;"/>
                                                    <div class="input-group-append">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control flatpickr-input" id="end_date" name="end_date" value="{{ old('end_date') }}" placeholder="Chọn ngày kết thúc" style="width: 100%;"/>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                    </div>
                                                </div>
