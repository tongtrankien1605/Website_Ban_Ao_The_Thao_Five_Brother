                            ...
                            <form method="post" enctype="multipart/form-data"
                                ...
                                <div class="card-body">
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" name="description" placeholder="Nhập mô tả">{{ $brand->description }}</textarea>
                                        @error('description')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div> --}}
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            @if ($brand->logo)
                                                <img src="{{ Storage::url($brand->logo) }}" alt="Logo thương hiệu" width="100px">
                                            @endif
